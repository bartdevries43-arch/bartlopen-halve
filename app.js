...
const CONFIG = {
  ...
  footEmoji:  "🏃",                     // 🏃‍♀️ of 🏃‍♂️, loper-emoji in footer + agenda
  ...
  goal:       "Je eerste halve marathon uitlopen",  // doel (groot in de hero)
  startDate:  new Date(2026, 6, 13),       // MAANDAG van week 1 (maand 0-based: 5 = juni)
  storeKey:   "bartlopen.halve.v1",         // UNIEKE opslagsleutel, per loper anders!
...
const PLAN = [
  ...
  { week: 1, dates: "13–19 jul", phase: "Fase 1 · Ritme & belastbaarheid", sessions: [
  ...
  { week: 2, dates: "20–26 jul", phase: "Fase 1 · Ritme & belastbaarheid", tuneup: true, tuneupTag: "Kuip Run", raceLabel: "🏁 Kuip Run", sessions: [
  ...
  { week: 3, dates: "27 jul–2 aug", phase: "Fase 1 · Ritme & belastbaarheid", sessions: [
  ...
  { week: 4, dates: "3–9 aug", phase: "Fase 1 · Ritme & belastbaarheid", recovery: true, sessions: [
  ...
  { week: 5, dates: "10–16 aug", phase: "Fase 2 · Duur opbouwen", sessions: [
  ...
  { week: 6, dates: "17–23 aug", phase: "Fase 2 · Duur opbouwen", sessions: [
  ...
  { week: 7, dates: "24–30 aug", phase: "Fase 2 · Duur opbouwen", sessions: [
  ...
  { week: 8, dates: "31 aug–6 sep", phase: "Fase 2 · Duur opbouwen", recovery: true, sessions: [
    ma({ zone: "herstel", km: 6,  title: "6 km heel rustig",   goal: "Herstelweek", blocks: ["6 km, langzamer dan 7:15/km"] }),
  ...
  { week: 9, dates: "7–13 sep", phase: "Fase 3 · Halve-marathonritme", sessions: [
  ...
  { week: 10, dates: "14–20 sep", phase: "Fase 3 · Halve-marathonritme", sessions: [
    ma({ zone: "duur",     km: 8,  title: "8 km rustig",      goal: "Volume", blocks: ["8 km op 6:45–7:15/km"] }),
  ...
  { week: 11, dates: "21–27 sep", phase: "Fase 3 · Halve-marathonritme", sessions: [
  ...
  { week: 12, dates: "28 sep–4 okt", phase: "Fase 3 · Halve-marathonritme", recovery: true, sessions: [
  ...
  { week: 13, dates: "5–11 okt", phase: "Fase 4 · Piek, taper & race", sessions: [
  ...
  { week: 14, dates: "12–18 okt", phase: "Fase 4 · Piek, taper & race", sessions: [
    ma({ zone: "duur", km: 9,  title: "9 km rustig",      goal: "Volume", blocks: ["9 km in Z2"] }),
  ...
  { week: 15, dates: "19–25 okt", phase: "Fase 4 · Piek, taper & race", taper: true, sessions: [
  ...
  { week: 16, dates: "26 okt–1 nov", phase: "Fase 4 · Piek, taper & race", taper: true, race: true, sessions: [
